...
- 2026-08-03 (2차): 모비딕 수준 상세 분석 이식 — 신강신약 v2(6단계 파이프라인, Python과 점수 1:1 일치),
  종합 용신(억부+조후+신뢰도), 합충형파해, 신살 21종, 공망 상세(旬), 근묘화실, 지장간 일수,
  대운(정확년수·전환일·십신·운성) + 세운/월운/일운 달력 인터랙티브 선택(대운→세운→월→일),
  md는 대운 전체+선택 범위 덤프. 지지 십신은 체용 기준(BRANCH_SIP_MAP).
  타로: 자유 타로(1~12장)·주제 5종(자유/연애/직업/관계/오늘)·태그 합성 조합해석·특수조합 5종.
  골든 테스트: 1999-10-18 01:11 남 → -2.83/0.649/3.479/금·수/75%/역행 3세 2.97년 (원본 Python 출력과 동일).
